      ...
      <div className='flex justify-between items-center'>
        <div className='flex gap-3 items-center'>
          <Link to={'/profile/' + post.author.username}>
            <img src={post.author.profilePicture} alt="" className='profile-img circle img-fit'/>
          </Link>
                ...
                <div className="comment-container flex items-center justify-between" key={comment._id}>
                  <div className="flex gap-2">
                    <Link to={'/profile/' + comment.user.username} className="self-start">
                      <img src={comment.user.profilePicture} alt="" className='profile-img-medium circle img-fit'/>
                    </Link>
